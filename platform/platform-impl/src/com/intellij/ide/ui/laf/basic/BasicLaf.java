 ...
 */
package com.intellij.ide.ui.laf.basic;
 ...
 * @author VISTALL
 *         <p/>
 *         Extract api from com.intellij.ide.ui.laf.darcula.DarculaLaf
 */
public abstract class BasicLaf extends BasicLookAndFeel{
  BasicLookAndFeel base;

  private final String myName;
  private final String myLowName;

  public BasicLaf(String n) {
    myName = n;
    myLowName = n.toLowerCase();
  ...
  public abstract DefaultMetalTheme createTheme();
  ...
  private void patchStyledEditorKit() {
    try {
      ...
      InputStream is = getClass().getResourceAsStream(myLowName + ".css");
  ...
  private  void loadDefaults(UIDefaults defaults) {
    ...
    try {
      InputStream stream = getClass().getResourceAsStream(myLowName + ".properties");
      properties.load(stream);
      stream.close();

      stream = getClass().getResourceAsStream(myLowName + "_" + osSuffix + ".properties");
      properties.load(stream);
      stream.close();

      HashMap<String, Object> darculaGlobalSettings = new HashMap<String, Object>();
      final String prefix = myLowName + ".";
  ...
  public String getDescription() {
    return "IntelliJ Light Look and Feel";
  }
