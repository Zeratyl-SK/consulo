...
public final class PropertyInspectorTable extends Table implements DataProvider{
  ...
  private final class MyCompositeTableCellRenderer implements TableCellRenderer{
    ...
    public MyCompositeTableCellRenderer(){
      ...
      myExpandIcon= UIUtil.isUnderBundledLaf() ? AllIcons.Mac.Tree_white_right_arrow : UIDesignerIcons.ExpandNode;
      myCollapseIcon=UIUtil.isUnderBundledLaf() ? AllIcons.Mac.Tree_white_down_arrow : UIDesignerIcons.CollapseNode;
